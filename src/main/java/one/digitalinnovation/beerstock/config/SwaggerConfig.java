...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Debora";
    private static final String CONTACT_GITHUB = "https://github.com/DTKx";
    private static final String CONTACT_EMAIL = "debora.koha@gmail.com";
